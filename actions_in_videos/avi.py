...
# Cell
class AVI:
    def __init__(self, filename, toPIL=False):
    ...
    def getFrame(self, frame_index):
        ...
        ret, frame = cap.read()
        if frame is None:
            print(f'ERROR in file: {self._filename.as_posix()}, frame-index: {frame_index}.')
            return frame
    ...
    def getRandomFrame(self, max_attempts=100):
        ...
        while frame is None and count < max_attempts:
            ...
            if frame_index is None:
                ...
                if frame is None:
                    print(f'ERROR in file: {self._filename}, frame_index: {frame_index}. Retrying with different random frame number.')
                    frame_index = None
        return frame
